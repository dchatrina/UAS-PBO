...
public class upMobil extends javax.swing.JFrame {
    Mobil mbl;

    public upMobil() throws ClassNotFoundException, SQLException {
        mbl = new Mobil();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        upData.setFont(new java.awt.Font("Comic Sans MS", 0, 12)); // NOI18N
        upData.setText("Ubah");
    ...
    private void upDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_upDataMouseClicked
        try {  
            ...
            try {
                new upMobil().setVisible(true);
            } catch (ClassNotFoundException | SQLException ex) {
                Logger.getLogger(upMobil.class.getName()).log(Level.SEVERE, null, ex);
            }
            this.dispose();
        }
        this.dispose();
